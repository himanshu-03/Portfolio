  ...
  return (
    <div className="flex font-sans w-full h-screen" style={{
      ...
      <div className="max-w-screen-lg flex flex-col align-items justify-center mx-auto my-auto md:flex-row">
        <div className='flex flex-col align-items justify-left text-white text-6xl font-bold'>
          Hey! I'm Himanshu Agarwal<br />
          <div className="flex flex-col align-items justify-left pt-8 font-normal text-xl text-slate-400">
            Software Developer | Data Analsyt<br /><br />
          </div>
          <div className="flex flex-col justify-left justify-left font-normal text-xl text-slate-400">
            <button style={{
                paddingLeft: "20px",
                width: "200px"
              }}>
        ...
        <div className="flex flex-row align-items justify-center mx-auto my-auto" >
          <img src = {Profile_Image} alt="Profile" class = "rounded-2xl mx-auto my-auto w-2/3 md:w-80" />
        </div>
      </div>
    </div>
  )
